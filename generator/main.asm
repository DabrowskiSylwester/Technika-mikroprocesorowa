...
cm_if_done:
	...
	rjmp cm_done
	call delay_20ms ; delay should prevent user from too quick 
	rjmp cm_loop ; otherwise return to begining
cm_done:
	sei ; enable interrupts
	; when settings are made programm jumps to proper section regarding signal form
	cpi r25, 1 
	rjmp PWM
	cpi r25, 2
	rjmp sine
...
delay_1s: ;assumption clock 16MHz
	push r17
	push r18
	push r19
	ldi r17, 255
